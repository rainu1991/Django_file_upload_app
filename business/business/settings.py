...
SECRET_KEY = '3p81lm80yzsg8bxmr$d33xd(mdj1)wg-3jm2s9t0vf=yht5v)o'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    #'/home/rainu/Desktop/Django/Businesscopy/business/businessapp/templates/myapp/',
    #os.path.join(PROJECT_ROOT, 'templates/myapp/'),
